 ...
 */
export class UciPrimarySmallButton extends BaseButton {
    constructor() {
     ...
     */
    connectedCallback() {
        this.setButtonClass(StaticVariables.ButtonTypePrimarySmall);
    }
 ...
 */
customElements.define('uci-primary-small-button', UciPrimarySmallButton, {extends: 'button'});